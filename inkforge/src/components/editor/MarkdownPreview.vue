...
watch(() => props.markdown, async (newVal) => {
  ...
  try {
    ...
    renderedHtml.value = DOMPurify.sanitize(rawHtml, {
      ADD_TAGS: ['section', 'nav', 'mark', 'sup', 'footer', 'details', 'summary', 'math', 'semantics', 'mrow', 'mi', 'mn', 'mo', 'annotation', 'svg', 'g', 'path', 'defs', 'marker', 'line', 'rect', 'circle', 'ellipse', 'polygon', 'polyline', 'text', 'tspan', 'animate', 'set', 'animateTransform'],
      ADD_ATTR: ['id', 'class', 'href', 'title', 'role', 'tabindex', 'aria-label', 'aria-hidden', 'style', 'data-tool', 'data-error', 'data-max-depth', 'data-numbered', 'data-highlight-color', 'data-footnote-id', 'data-footnote-index', 'data-footnote-ref-index', 'data-citation-id', 'data-citation-kind', 'data-citation-raw', 'data-citation-keys', 'data-citation-style', 'data-citation-missing', 'data-bibliography-key', 'data-source-url', 'data-wikilink-target', 'data-wikilink-anchor', 'data-wikilink-resolved', 'data-emoji-name', 'open', 'data-summary', 'data-inkforge-details', 'data-details-content', 'xmlns', 'viewBox', 'd', 'x', 'y', 'x1', 'x2', 'y1', 'y2', 'cx', 'cy', 'r', 'rx', 'ry', 'points', 'marker-end', 'stroke', 'fill', 'transform', 'text-anchor', 'begin', 'dur', 'values', 'keyTimes', 'keySplines', 'calcMode', 'repeatCount', 'repeatDur', 'restart', 'attributeName', 'attributeType', 'type', 'from', 'to', 'font-size', 'font-weight', 'font-family', 'opacity', 'pointer-events', 'data-ink-svg', 'dominant-baseline', 'letter-spacing']
    })
  } catch (e) {
