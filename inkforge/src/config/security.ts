...
export interface PasswordPolicyConfig {
    ...
    readonly SPECIAL_CHARS_REGEX: RegExp
}
...
export const SSRF_PROTECTION = {
    ...
    IPV6_PRIVATE_PREFIXES: [
        ...
        'fe80',
        'fec0',
        '::ffff:0.',          // IPv4 映射零地址 (0.0.0.0/8)
        '::ffff:127.',        // IPv4 映射回环 (127.0.0.0/8)
        '::ffff:10.',         // IPv4 映射私有 (10.0.0.0/8)
        '::ffff:172.16.',     // IPv4 映射私有 (172.16.0.0/12: 172.16-31.x.x)
        '::ffff:172.17.',
        '::ffff:172.18.',
        '::ffff:172.19.',
        '::ffff:172.20.',
        ...
        '::ffff:172.30.',
        '::ffff:172.31.',
        '::ffff:192.168.',    // IPv4 映射私有 (192.168.0.0/16)
        '::ffff:169.254.',    // IPv4 映射链路本地 (169.254.0.0/16, 含 AWS 元数据)
    ] as const,
