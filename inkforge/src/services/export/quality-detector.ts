...
const MARKET_EDITOR_RESIDUE_RULES = [
  ...
  {
    pattern: /<[a-zA-Z][^>]*\b(?:uib-(?:dropdown(?:-(?:toggle|menu))?|tooltip|accordion(?:-[\w-]+)?|collapse|modal(?:-[\w-]+)?|tab(?:set|-(?:heading|content)-transclude)?|btn-(?:radio|checkbox))|tooltip-(?:placement|popup-delay))\s*=/i,
