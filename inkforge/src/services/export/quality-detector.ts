...
const MARKET_EDITOR_RESIDUE_RULES = [
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:\bid\s*=\s*["'](?:nav-header|top-style-tools|site-annoucement-list|login-menus|left-operate-menu|left-advertises)["']|\bclass\s*=\s*["'][^"']*\b(?:bg-header|category-nav|left_side__menu|ai_subsystem_nav)\b[^"']*["'])/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\banimate-op-btn-panel\b[^"']*["']/i,
    label: 'Xiumi animate operation panel residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'](?:[^"']*\s)?(?:x3-nav-op-buttons|tn-op-btn-group|op-btn(?:-[\w-]+)?|op-more)(?=\s|["'])[^"']*["']/i,
    label: 'Xiumi top operation button residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:x3-navbar|x3-nav-(?:brand|path|misc))\b[^"']*["']/i,
    label: 'Xiumi navigation shell residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*\b(?:uib-(?:dropdown(?:-(?:toggle|menu))?|tooltip|accordion(?:-[\w-]+)?|collapse|modal(?:-[\w-]+)?|tab(?:set|-(?:heading|content)-transclude)?|btn-(?:radio|checkbox))|modal-(?:render|in-class|animation)|tooltip-(?:placement|popup-delay))\s*=/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:(?:class|id)\s*=\s*["'][^"']*\b(?:color-selector-dropdown|op-theme-color-sec|text-color-btn|tn-color-circle|tn-color-selector(?:-x)?|text-shadow-icon|text-fill-image-icon)\b[^"']*["']|\b(?:tn-color-selector(?:-x)?|hello-color-x|on-color-(?:choose|changing|choose-cancel)|support-color-category|fetch-color-from-template-panel|support-batch-change-color)\s*=)/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:in-text-cell-editing-op|cp-op-quick-input-prompt|op-text-img-resizing-surface|text-bgd-shadow|toggle-color-btn)\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-cp-[\w-]+\b[^"']*["']/i,
    label: 'Xiumi component operation depot action residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-ce-(?:audio-card|music-card|map(?:-tx)?|profile-card|redpack-cover|svg(?!-)|video-(?:card|link|tx|xm))\b[^"']*["']/i,
    label: 'Xiumi component depot native control residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-ce-(?:animation|svg-animate|svg-animation)\b[^"']*["']/i,
    label: 'Xiumi component depot SVG animation residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-ce-(?:out-cell-edit|play-cp-link)\b[^"']*["']/i,
    label: 'Xiumi component depot external edit link residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-ce-input-(?:checkbox|radio|select|text|multi-line-text)\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\bdc-ce-classic-table-(?:column-width|grid|merge|quickly|style|width)\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\btn-attribute-stack-panel(?:-root)?\b[^"']*["']/i,
    label: 'Xiumi attribute stack panel residue',
  },
  {
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\busr-info-desc-frame\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:op-c[pe]-image-enhancement|op-ce-image-popup|enhance-attr-menu|thumb-crop-img)\b[^"']*["']/i,
    label: 'Xiumi image enhancement crop control residue',
  },
  {
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'](?![^"']*\bdc-ce-crop-image-crop\b)[^"']*\bcrop-(?:panel|attr-menu|ratio-item|image)\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:bg-attr-menu|bg-repeat-select|bg-attach-check|ce-op-background|op-cp-bg-bar)\b[^"']*["']/i,
    label: 'Xiumi background attribute control residue',
  },
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:op-comp-animation-attr-board|op-attr-view-cp-animation(?:-[\w-]+)?|anim-selector-x)\b[^"']*["']/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*(?:class|id)\s*=\s*["'][^"']*\b(?:anim-(?:desc|expand-bottom|icon|style|styles)|animate-(?:styles-type|general))\b[^"']*["']/i,
    label: 'Xiumi animation style picker residue',
  },
  {
  ...
  {
    pattern: /<[a-zA-Z][^>]*\btn-pull-to-refresh\s*=/i,
  ...
  {
    pattern: /<[a-zA-Z][^>]*\btn-(?:sound|comment)\s*=/i,
    label: 'Xiumi sound/comment binding metadata residue',
  },
  {
