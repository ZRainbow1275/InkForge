...
const MARKET_EDITOR_135_STYLE_PANEL_NAV_CHROME_RESIDUE_HTML = [
  '<section><p>Readable article text that should not carry style-panel navigation chrome.</p></section>',
  '<aside id="style-categories"><button>Title</button><button>Body</button><button>SVG</button></aside>',
  '<span id="style-sorts" class="display_flex_ac icon-hover">Recent</span>',
...
const MARKET_EDITOR_135_HELPER_IFRAME_RESIDUE_HTML = [
  '<section><p>Readable article text that should not carry editor helper iframe chrome.</p></section>',
  '<iframe id="ai_polish_box_iframe"></iframe>',
  '<iframe id="js_shared_iframe" src=""></iframe>',
  '<iframe id="svg_editor_iframe"></iframe>',
  '<iframe id="ueditor_0" src="about:blank"></iframe>',
  '<iframe id="frame" class="main" _src="/style-center?cate_id=100&order=id#ifarme_bjq"></iframe>',
].join('')

const MARKET_EDITOR_135_ANNOUNCEMENT_LINK_RESIDUE_HTML = [
  '<section><p>Readable article text that should not carry editor announcement chrome.</p></section>',
  '<a class="announcement unread" data-id="402" href="https://www.135editor.com/announcements/view/402">Notice</a>',
].join('')
...
const MARKET_EDITOR_135_ACTION_RAIL_CHROME_RESIDUE_HTML = [
  '<section><p>Readable article text that should not carry editor action rail controls.</p></section>',
  '<aside class="editorslide">',
  '<a id="copy-editor-html" class="btn btn-default btn-xs">Copy</a>',
  '<a id="quick-save-template" class="btn btn-default btn-xs">Quick save</a>',
  '<a id="save-as-template" class="btn btn-default btn-xs">Save and sync</a>',
  '<a id="preview-editor" class="btn btn-default btn-xs">Preview</a>',
  '<a id="sync_official_accounts" class="btn btn-default btn-xs">Sync Official Account</a>',
  '</aside>',
].join('')
...
const MARKET_EDITOR_135_SVG_ARTICLES_ANCHOR_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="articles-anchor">',
  '<article class="article-item"><p>135 SVG editor center articles anchor.</p></article>',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_135_SVG_TOOLBAR_RESIDUE_HTML = [
  ...
  '<div class="toolbar-tool editor-toolbar__tool">',
  '<div class="bar-item disabled"><span class="bar-item__label">撤销</span></div>',
  '<span class="delete-dropdown_entry">删除</span>',
  '<span class="tool-dropdown_entry header__link menu">工具</span>',
  '</div>',
  '<a class="team_btn">个人模式</a>',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_135_SVG_SIDEBAR_ICON_HELP_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="side-tab-menu__icon-box">',
  '<img class="side-tab-menu__icon" src="about:blank" alt="">',
  '</div>',
  '<div class="side-bar-banner-wrap"></div>',
  '<div class="sidebar-help black"></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_135_SVG_MATERIAL_COMPONENT_PATH_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div file_path="sidebar/tabs/ItemElement"><span>135 SVG物料组件路径残留</span></div>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_USER_HEADER_CHROME_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="header-user">',
  '<div class="user-info noheader">',
  '<img class="user-info__head" alt="">',
  '<div class="user-info__nickname"><span>[个人模式]</span><span>账号昵称已省略</span></div>',
  '</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_HEADER_LOGO_MENU_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="header__logo">',
  '<a class="header__link menu" href="/svgeditor/"><span>Home</span></a>',
  '<img class="logo" src="img/logo_name.07fb4af3.png" alt="">',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_WORK_TITLE_CONTROL_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="work-title">',
  '<div class="edit-text work-title__editing">',
  '<input class="edit-text__input" placeholder="作品标题" type="text">',
  '</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_WORK_TOOL_QUICK_ENTRY_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="work-tool-signature fixed">',
  '<div class="ant_btn_panel">',
  '<div class="idea-entry-quick">',
  '<div class="entry-popover">',
  '<button type="button" class="btn-entry ant-btn"></button>',
  '</div>',
  '</div>',
  '</div>',
  '</div>',
...
const MARKET_EDITOR_135_SVG_MATERIAL_LIST_ITEM_RESIDUE_HTML = [
  ...
  '<div class="item-element_id"><span>ID: 1060</span></div>',
  '<div class="item-element__box">',
  '<div class="item-tag_wrap"><div class="item-element__help"></div>',
  '<div class="item-content__tag"><span>NEW</span></div></div>',
  '<div class="item-element__title"><span>多选一点击弹出</span></div>',
  '<div class="item-element__price"><div class="item-line">',
  '<div class="element-price__wrap"><span>特惠69元/年</span></div>',
  '<div class="element-actions__wrap"><button class="btn btn-buy">免费试用</button></div>',
  '</div></div>',
  '</div>',
  '<div class="item-summary-tag"></div>',
  '<div class="item-collect-tag" title="收藏"></div>',
  '</article>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_FILTER_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="menu-filter">',
  '<div class="menu-filter__container">',
  '<div class="menu-filter__group">',
  '<a class="menu__warp_btn">点击</a>',
  '<a class="level_entry">全部</a>',
  '<div class="menu-level__group"></div>',
  '</div>',
  '</div>',
  '</div>',
  '<div class="svg-types">',
  '<a class="tab-switch_btn active">全部</a>',
  '<a class="tab-switch_btn">组件</a>',
  '</div>',
  '<div class="special-tags__left"></div>',
  '<div class="special-tags__right"><div class="special-tags__cover"></div></div>',
  '<div class="tab-visible_cat"><div class="preview-guide">切换预览模式</div></div>',
  '<span class="usage-history"><span class="modal-entrance">最近</span></span>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_WRAPPER_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div id="tab_special_functions" class="tab-special__functions">',
  '<div class="tab-special__tags"></div>',
  '<div class="tab-special__tap"><div class="tab-special__list"></div></div>',
  '</div>',
  '<div class="tab-menufilter">',
  '<div class="filter_category is_open">',
  '<div class="filter-list__fold"><span>收起分类</span></div>',
  '</div>',
  '</div>',
  '<div class="svgMubanYaoqingEnter"><a href="/svgmuban.html">SVG模板活动</a></div>',
  '<img class="img-preview-hide" src="about:blank">',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_PREVIEW_ASSET_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<img src="img/img-preview-show.0471d3a6.svg" alt="">',
  '<img src="img/img-preview-hide.bff8f2cc.svg" alt="">',
  '<p>Clean article text.</p>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_ACTION_ASSET_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<img src="img/message.6ba842d4.svg" alt="">',
  '<span>Readable material note.</span>',
  '<img src="img/collect.645fe3be.svg" alt="">',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_HELPER_ASSET_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<img src="img/hot.74ee6ac4.png" alt="">',
  '<span>Readable category text.</span>',
  '<img src="img/icon-up2.e0ef1973.png" alt="">',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_LIST_LOADER_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="list-loader black" issvglist="true">',
  '<div class="list-loader__inner"></div>',
  '<div class="list-loader__load">加载更多</div>',
  '<div class="list-loader__loading"><div class="list-loader__loading-inner">加载中</div></div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_135_SVG_MATERIAL_PURCHASE_CHILD_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<span class="discount-instructions"><i>尝鲜价：55.2元/年</i>',
  '<i class="discount-desc">(8折限时两周)</i></span>',
  '<button type="button" class="btn-buy ant-btn"><span>免费试用</span></button>',
  '<button type="button" class="ant-btn btn-buy"><span>立即购买</span></button>',
  '</section>',
].join('')
...
const MARKET_EDITOR_135_SVG_MATERIAL_PANEL_CHILD_RESIDUE_HTML = [
  '<section style="margin:0;padding:0">',
  '<div class="edit-image black"><div class="image__title-bar">添加背景图</div></div>',
  '<div class="edit-add-images"><div class="edit-add-btn"><div class="edit-add__title">添加弹出图</div></div></div>',
  '<div class="edit-animate"><div class="edit-animate__title">动画设置</div>',
  '<div class="edit-animate__opt animate__dur"><span class="opt__title">弹出渐显时长</span></div></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_ANGULAR_INPUT_EVENT_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<input ng-keydown="onKeydown($event)" ng-keyup="onKeyup($event)" ng-readonly="readonly">',
  '<img ng-src="/xiumi-local-placeholder.png" ng-mousedown="drag.start($event)" ng-mouseup="drag.end($event)">',
  '<button ng-copy="copy()" ng-transclude="slot" ng-mouseenter="hover()">Angular event residue</button>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_OPERATION_PANEL_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div tn-panel-move="" tn-op-back-mask="">',
  '<button tn-op-menu="">Xiumi operation panel directive residue</button>',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMPONENT_OPERATION_DEPOT_ACTION_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-cp-link"></li>',
  '<li class="dc-cp-copy-to-clipboard"></li>',
  '<li class="dc-cp-wx-miniprogram-link"></li>',
  '<li class="dc-cp-out-comp-edit"></li>',
  '<li class="dc-cp-quick-input-prompt"></li>',
  '<li class="dc-cp-replace-template"></li>',
  '<li class="dc-cp-rolling-over"></li>',
  '<li class="dc-cp-zorder"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_OPERATION_PANEL_COMPONENT_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-cp-animation"></div>',
  '<div class="op-cp-insert-text"></div>',
  '<div class="op-cp-margin"></div>',
  '<div class="op-cp-margin-tb"></div>',
  '<div class="op-cp-save"></div>',
  '<div class="op-cp-scale"></div>',
  '<div class="op-ce-bg-bar"></div>',
  '<div class="op-ce-profile-card"></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_STATE_LOADING_UTILITY_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-state-transition-animation"></div>',
  '<div class="tn-input-sortable-group"></div>',
  '<button class="tn-bar-btn-active-color"></button>',
  '<section class="tn-loading-overlap"></section>',
  '<div class="tn-top-loading-block"></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_NATIVE_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-audio-card"></li>',
  '<li class="dc-ce-map-tx"></li>',
  '<li class="dc-ce-profile-card"></li>',
  '<li class="dc-ce-redpack-cover"></li>',
  '<li class="dc-ce-video-card"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_SVG_ANIMATION_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-animation"></li>',
  '<li class="dc-ce-svg-animate"></li>',
  '<li class="dc-ce-svg-animation"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_EXTERNAL_EDIT_LINK_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-out-cell-edit"></li>',
  '<li class="dc-ce-play-cp-link"></li>',
  '</ul>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_LAYOUT_GEOMETRY_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-layout-free"></li>',
  '<li class="dc-ce-layout-fixed-aspect-ratio"></li>',
  '<li class="dc-ce-layout-scroll-direction"></li>',
  '<li class="dc-ce-static-position-size"></li>',
  '<li class="dc-ce-auto-align"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-classic-table-column-width"></li>',
  '<li class="dc-ce-classic-table-grid"></li>',
  '<li class="dc-ce-classic-table-merge"></li>',
  '<li class="dc-ce-classic-table-quickly"></li>',
  '<li class="dc-ce-classic-table-style"></li>',
  '<li class="dc-ce-classic-table-width"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_AUXILIARY_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-table-column-width"></li>',
  '<li class="dc-ce-table-grid"></li>',
  '<li class="dc-ce-table-style-brush"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_IMAGE_TRANSFORM_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-crop-image-crop"></li>',
  '<li class="dc-ce-image-animation"></li>',
  '<li class="dc-ce-image-crop"></li>',
  '<li class="dc-ce-image-design"></li>',
  '<li class="dc-ce-image-enhancement"></li>',
  '<li class="dc-ce-image-flip"></li>',
  '<li class="dc-ce-image-for-layout-datum"></li>',
  '<li class="dc-ce-image-library"></li>',
  '<li class="dc-ce-image-png-size"></li>',
  '<li class="dc-ce-image-popup"></li>',
  '<li class="dc-ce-image-replace-color"></li>',
  '<li class="dc-ce-image-src"></li>',
  '<li class="dc-ce-image-straw-color"></li>',
  '<li class="dc-ce-image-style-brush"></li>',
  '<li class="dc-ce-image-svg-clip"></li>',
  '<li class="dc-ce-image-to-background"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_BOX_STYLE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-background"></li>',
  '<li class="dc-ce-box-border"></li>',
  '<li class="dc-ce-box-formats"></li>',
  '<li class="dc-ce-box-metrics"></li>',
  '<li class="dc-ce-box-shadow"></li>',
  '<li class="dc-ce-transparency"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TYPOGRAPHY_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-font-size-scale"></li>',
  '<li class="dc-ce-paragraph-margin"></li>',
  '<li class="dc-ce-text-all"></li>',
  '<li class="dc-ce-text-code"></li>',
  '<li class="dc-ce-text-decoration"></li>',
  '<li class="dc-ce-text-shadow"></li>',
  '<li class="dc-ce-text-shadow-style"></li>',
  '</ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_MOBILE_VIEWPORT_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul>',
  '<li class="dc-ce-mobile-background"></li>',
  '<li class="dc-ce-mobile-group"></li>',
  '<li class="dc-ce-mobile-image"></li>',
  '<li class="dc-ce-mobile-text"></li>',
  '<li class="dc-ce-mobile-unsupport"></li>',
  '</ul>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_ATTRIBUTE_BOARD_CONTROL_RESIDUE_HTML = [
  ...
  '<div class="tn-attr-assemble-tabs">Xiumi attribute board residue</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ATTRIBUTE_STACK_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-attribute-stack-panel-root">',
  '<div class="tn-attribute-stack-panel">Xiumi attribute stack panel residue</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_GENERATED_LINK_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-gen-link">Xiumi generated link control residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_MEDIA_UPLOAD_INPUT_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<p class="tn-audio-uploader"><input id="audioFileUploadInput" type="file" accept=".mp3,.m4a"></p>',
  '<p class="tn-video-uploader"><input id="videoFileUploadInput" type="file" accept=".mp4,.mov"></p>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_AUDIO_LIBRARY_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<audio id="audio-library-control" class="bgm-audio" controls></audio>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_LOGIN_LAYER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<section class="tn-login-layer full-fill-a">',
  '<div class="auth-wnd wx-auth-wnd container">秀米授权管理</div>',
  '</section>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_AUDIO_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="audios">',
  '<div class="audio-panel btn-group">',
  '<button class="audio-src">点击选择音乐</button>',
  '<button class="audio-edit"></button>',
  '<button class="audio-del"></button>',
  '</div>',
  '<div class="audio-status">关闭背景音乐（仅限本页）</div>',
...
const MARKET_EDITOR_XIUMI_LAYOUT_FORM_PANEL_RESIDUE_HTML = [
  ...
  '<section class="form-input-panel">Name required option controls</section>',
  '<div class="op-ce-form-input">Form input operation controls</div>',
  '<ul class="trigger-props-panel">Trigger properties controls</ul>',
  '<input class="trigger-radio-input" type="radio" value="1">',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_LAYOUT_FORM_CHILD_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="cell-layout-box btn-group dropdown">Settings</div>',
  '<input class="form-control padding-input" value="12">',
  '<li class="presentation menuitem-level">Insert column</li>',
  '<label class="control-label attr-thin-label">Layer</label>',
  '<button class="btn attr-btn" type="button">Confirm</button>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_DARK_MASK_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-dark-mask">Xiumi dark mask control residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_WECHAT_COVER_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-ce-wx-cover">Xiumi WeChat cover control residue</div>',
  '<div class="op-dark-mask"></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COVER_PLACEHOLDER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="cover-imgs">',
  '<div class="cover-placeholder second-placeholder">',
  '<div class="cover-mask"><span class="mask-border"></span></div>',
  '</div>',
...
const MARKET_EDITOR_XIUMI_COVER_IMAGE_DESC_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
...
const MARKET_EDITOR_XIUMI_MENU_INPUT_ICON_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<input class="op-menu-input spacing-input" value="1.5">',
  '<img class="op-menu-icon" src="data:image/png;base64,AA==" alt="">',
  '<img class="op-bar-item-icon" src="data:image/png;base64,AA==" alt="">',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_HAMMER_PAN_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<span hm-pan="onResizePan($event)">Xiumi hammer pan directive residue</span>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_CROP_PANEL_CHILD_CONTROLS_HTML = [
  '<section style="margin:10px 0">',
  '<div class="crop-panel">',
  '<div class="crop-attr-menu">Xiumi crop panel child control residue</div>',
  '<label class="crop-ratio-item">1:1</label>',
  '<img class="crop-image" src="data:image/png;base64,AA==" alt="">',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_BACKGROUND_ATTRIBUTE_CONTROL_RESIDUE_HTML = [
  ...
  '<select class="bg-repeat-select"><option>repeat</option></select>',
  '<input class="bg-attach-check" type="checkbox">',
  '<div class="ce-op-background"></div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_BACKGROUND_BAR_CHILD_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-cp-bg-bar">Xiumi background attribute control residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ANIMATION_ATTRIBUTE_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-comp-animation-attr-board op-attr-view-cp-animation anim-selector-x">',
  'Xiumi animation attribute panel residue',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ANIMATION_PANEL_CHILD_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="anim-unit-container">',
  '<div class="anim-item-list">',
  '<div class="anim-title-bar">Xiumi animation panel child residue</div>',
  '<div class="anim-unit-box anim-clipboard"></div>',
  '</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="animate-general">',
  '<label class="animate-styles-type">Entrance</label>',
  '<div class="anim-styles">',
  '<div class="anim-style">',
  '<span class="anim-icon"></span>',
  '<span class="anim-desc">Xiumi animation style picker residue</span>',
  '</div>',
  '</div>',
  '</div>',
  '</section>',
...
const MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_ICON_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<span class="anim-expand-bottom"></span>',
  '<p>Xiumi animation style picker icon residue</p>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_UI_BOOTSTRAP_MODAL_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div uib-modal-animation-class="fade">Modal animation shell</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_MODAL_RUNTIME_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div modal-render="true" modal-in-class="in" modal-animation="true">Modal runtime shell</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_DROPDOWN_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div tn-dropdown="">',
  '<button tn-dropdown-toggle="">Xiumi dropdown directive residue</button>',
  '<ul tn-dropdown-menu=""><li><a>Menu item</a></li></ul>',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COLOR_PALETTE_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div id="tnColorPaletteInst" class="tn-color-palette-panel">',
  '<div id="tnColorPaletteMask" class="tn-color-palette-panel-mask"></div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COLOR_PICKER_TRIGGER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div id="tnColorPickerTrigger" style="display:none"></div>',
  '<div id="tnGradientColorPickerTrigger" style="display:none"></div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COLOR_SELECTOR_CONTROL_RESIDUE_HTML = [
  ...
  '<span class="op-theme-color-sec text-center" title="主题色"></span>',
  '<div class="op-text-sec text-color text-color-btn" title="文字颜色"></div>',
  '<button support-color-category="solid-gradient" on-color-choose="onColorChoose(color)">色板</button>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_FONT_FORMAT_CONTROL_RESIDUE_HTML = [
  ...
  '<ul class="font-family-list"><li><span class="face stc-family-name-yzk--1">默认字体</span></li></ul>',
  '</div>',
  '<div class="text-format-brush">提取文字格式</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_TEXT_INPUT_BEGIN_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<input type="text" tn-text-input-begin="onTextPropInputBegin()" value="标题">',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_TEXT_OPERATION_SECTION_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-text-sec"></div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_TEXT_EDITING_FLYOUT_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="in-text-cell-editing-op">Text flyout controls</div>',
  '<div class="cp-op-quick-input-prompt">Quick input</div>',
  '<div class="op-text-img-resizing-surface"></div>',
  '<ul class="text-bgd-shadow"><li class="toggle-color-btn">Color</li></ul>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_BRUSH_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="brush-panel dropdown">Format list can be dragged and pinned.</div>',
  '<img class="icon-image" alt="brush">',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ATTR_CONTEXT_HOST_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
...
const MARKET_EDITOR_XIUMI_MENU_PIN_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-cp-menu-pin">',
  '<div class="op-cp-menu-pin-tb"></div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ACCOUNT_SYNC_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="wx-user-panel dropdown-menu">Authorization and sync settings</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_MESSAGE_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="usr-message-box dropdown">',
  '<a class="message-box-toggle dropdown-toggle">0</a>',
  '<div class="dropdown-menu">',
  '<a class="turn-to-message-setting">Message settings</a>',
  '<a class="turn-to-message-list">All messages</a>',
  '</div>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_USER_PROFILE_MENU_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="usr-info-desc-frame dropdown-menu">Account settings, invoices, and sign out.</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_PROMPT_BANNER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-compatible-prompt">Browser compatibility notice.</div>',
  '<div class="tn-operate-prompt">Copy and plugin operation notice.</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_HEADER_SHELL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<header class="tn-header tn-state-transition-animation">',
  '<div class="navbar-static-top">Editor header shell</div>',
  '</header>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMMENT_TOOLBAR_PANEL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="page-comment-on-toolbar">Xiumi comment toolbar residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_PANEL_HEADER_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<span class="glyphicon glyphicon-menu-hamburger panel-handler"></span>',
  '<span class="glyphicon glyphicon-tree-conifer panel-placeholder"></span>',
  '<span class="glyphicon glyphicon-remove panel-close"></span>',
  '<div class="panel-header text-center hammer-handler"></div>',
  '<div class="comment-panel-header text-center">0 / 0</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_PAGE_TOOLBAR_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<ul class="tn-page-toolbar"><li>Xiumi page toolbar residue</li></ul>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_PLACEHOLDER_METADATA_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div tn-placeholder="{ Click edit }">Xiumi placeholder metadata residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_LAYER_AUTHORING_TREE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-layer tn-layer-absolute">Xiumi layer authoring tree residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_PAGE_AUTHORING_TREE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-page tn-page-root">Xiumi page authoring tree residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_TEMPLATE_AUTHORING_TREE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-tpl tn-tpl-card">Xiumi template authoring tree residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_TEMPLATE_LIST_REFRESH_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div tn-pull-to-refresh="">Xiumi template list refresh directive residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_TEMPLATE_SCENE_MARKER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-scene-paper">Xiumi template scene marker residue</div>',
  '<div class="tn-lighting-box">Xiumi template scene marker residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_IMAGE_ENHANCEMENT_CROP_CONTROL_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="op-cp-image-enhancement">Xiumi image enhancement crop control residue</div>',
  '<div class="op-ce-image-enhancement">Xiumi image enhancement crop control residue</div>',
  '<section class="enhance-attr-menu">Xiumi image enhancement crop control residue</section>',
  '<div class="op-ce-image-popup">Xiumi image enhancement crop control residue</div>',
  '<div class="thumb-crop-img">Xiumi image enhancement crop control residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_BASIC_STYLE_FRAGMENT_RESIDUE_HTML = [
  ...
  '<section class="flow-page-basic-style">',
  '<div class="basic-style-desc">16px, line height 1.6, letter spacing 0</div>',
  '</section>',
  '</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_THEME_COLOR_MASK_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-theme-color-mask tn-theme-color-mask-active">Xiumi theme color mask residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_SORTABLE_PIN_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-sortable-pin">Xiumi sortable pin residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_QUICK_INPUT_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-quick-input-block">Xiumi quick input residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_QUICK_INPUT_INSTANCE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-__quick_input__-inst">Xiumi quick input instance residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_STATE_TOGGLE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-state-active">Xiumi state toggle residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_EDITING_STATE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-on-child-editing">Xiumi editing state residue</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMPONENT_TEMPLATE_BINDING_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-bind-comp-tpl-id="edit_paper-cp:sys-edit/loader-multi-pages" tn-bind-comp-index="0">',
  'Xiumi component template binding shell',
  '</article>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_COMPONENT_IDENTITY_METADATA_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-uuid="cube-redacted">Xiumi component identity metadata shell</article>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_ANIMATION_BINDING_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-animate="compAttr.anim" tn-animate-on-self="true">Xiumi animation binding shell</article>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_LINK_BINDING_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-link="cell.link">Xiumi link binding shell</article>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_IMAGE_BINDING_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-image="cell.image" tn-image-usage="cover">Xiumi image binding shell</article>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_COMPONENT_STRUCTURE_BINDING_RESIDUE_HTML = [
  ...
  'Xiumi component structure binding shell',
  '</article>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_CELL_BINDING_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<article tn-cell="card.cells[0]" tn-cell-type="text">Xiumi cell binding shell</article>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_ATOM_DRAG_DROP_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="tn-atom-dragging-source tn-atom-dropping-sink">Xiumi atom drag drop residue</div>',
  '</section>',
].join('')

const MARKET_EDITOR_XIUMI_EDITOR_INTERACTION_DIRECTIVE_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div tn-snatch-at="paper.root" tn-ui-droppable="dropOptions">',
  '<article tn-comp-enter-editing="enter(comp)" tn-comp-exit-editing="exit(comp)">Editing state</article>',
  '<ol tn-data-list="tnDataList"><li tn-bind-comp-inst-page-mode="paper.mode">Template row</li></ol>',
  '</div>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_TEMPLATE_CARD_HOVER_RESIDUE_HTML = [
  '<section style="margin:10px 0">',
  '<div class="inner-image-box lighting-hover">Xiumi template card hover residue</div>',
  '<li class="comp-feature-matched large-tpl"></li>',
  '</section>',
].join('')
...
const MARKET_EDITOR_XIUMI_DOCUMENT_SELECTION_SHELL_RESIDUE_HTML = [
  '<article class="multi-comp-select-panel">',
  '<section class="dock-loader">Xiumi document selection shell residue</section>',
  '<div class="tn-fly-away-workaround-ios13"></div>',
  '</article>',
].join('')
...
describe('platform native export rendering rules', () => {
  ...
  itWithCommittedStyleProofValidationClock('audits committed local and WeChat PC evidence together without merging exact-artifact claims', () => {
    ...
    const kilnPasteSafeProgress = wechatAudit.progress.choices.find(choice =>
      choice.choice.id === 'wechat-flagship-kiln-paste-safe'
    )
  ...
  it('blocks 135 style panel navigation chrome without style-card metadata', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_STYLE_PANEL_NAV_CHROME_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_STYLE_PANEL_NAV_CHROME_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_STYLE_PANEL_NAV_CHROME_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 style panel navigation chrome residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 style panel navigation chrome residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 style panel navigation chrome residue')
  ...
  it('blocks 135 helper iframe chrome without full-page navigation metadata', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_HELPER_IFRAME_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_HELPER_IFRAME_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_HELPER_IFRAME_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 editor helper iframe residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 editor helper iframe residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 editor helper iframe residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 full-page navigation chrome residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 UEditor toolbar/editor chrome residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks 135 announcement link chrome without full-page navigation metadata', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_ANNOUNCEMENT_LINK_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_ANNOUNCEMENT_LINK_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_ANNOUNCEMENT_LINK_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 announcement link chrome residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 announcement link chrome residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 announcement link chrome residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 full-page navigation chrome residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 editor helper iframe residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })
  ...
  it('blocks 135 editor action rail chrome without toolbar or style residues', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_ACTION_RAIL_CHROME_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_ACTION_RAIL_CHROME_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_ACTION_RAIL_CHROME_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 editor action rail chrome residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 editor action rail chrome residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 editor action rail chrome residue')
  ...
  it('blocks 135 SVG editor articles-anchor wrapper without article list shell', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_ARTICLES_ANCHOR_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_ARTICLES_ANCHOR_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_ARTICLES_ANCHOR_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG editor articles anchor residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG editor articles anchor residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG editor articles anchor residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG editor article list wrapper residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG editor shell residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks 135 SVG editor toolbar controls without shell or material panels', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_TOOLBAR_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_TOOLBAR_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_TOOLBAR_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks 135 SVG sidebar icon/help chrome without sidebar navigation wrappers', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_SIDEBAR_ICON_HELP_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_SIDEBAR_ICON_HELP_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_SIDEBAR_ICON_HELP_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG sidebar icon/help residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG sidebar icon/help residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG sidebar icon/help residue')
  ...
  it('blocks 135 SVG material component path attributes without item-card classes', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_COMPONENT_PATH_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_COMPONENT_PATH_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_COMPONENT_PATH_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material component path residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material component path residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material component path residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material list item residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG sidebar navigation residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks 135 SVG user header chrome without toolbar classes', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_USER_HEADER_CHROME_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_USER_HEADER_CHROME_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_USER_HEADER_CHROME_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG user header chrome residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG user header chrome residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG user header chrome residue')
  ...
  it('blocks 135 SVG header logo menu without user header or toolbar chrome', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_HEADER_LOGO_MENU_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_HEADER_LOGO_MENU_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_HEADER_LOGO_MENU_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG header logo menu residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG header logo menu residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG header logo menu residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG user header chrome residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG editor toolbar residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG work title edit control residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks 135 SVG work title edit controls without header chrome', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_WORK_TITLE_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_WORK_TITLE_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_WORK_TITLE_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG work title edit control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG work title edit control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG work title edit control residue')
  ...
  it('blocks 135 SVG work tool quick-entry controls without toolbar chrome', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_WORK_TOOL_QUICK_ENTRY_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_WORK_TOOL_QUICK_ENTRY_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_WORK_TOOL_QUICK_ENTRY_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG work tool quick-entry residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG work tool quick-entry residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG work tool quick-entry residue')
  ...
  it('blocks 135 SVG material list item actions without sidebar or panel wrappers', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_ITEM_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_ITEM_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_ITEM_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material list item residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material list item residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material list item residue')
  ...
  it('blocks 135 SVG material filter controls without sidebar or list-card wrappers', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_FILTER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_FILTER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_FILTER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material filter control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material filter control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material filter control residue')
  ...
  it('blocks 135 SVG material category wrappers without filter or list-card controls', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_WRAPPER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_WRAPPER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_WRAPPER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material category wrapper residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material category wrapper residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material category wrapper residue')
  ...
  it('blocks 135 SVG material preview asset paths without preview classes', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PREVIEW_ASSET_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PREVIEW_ASSET_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PREVIEW_ASSET_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material preview asset residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material preview asset residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material preview asset residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material category wrapper residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material filter control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG sidebar icon asset residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks 135 SVG material action asset pairs without item-card classes', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_ACTION_ASSET_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_ACTION_ASSET_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_ACTION_ASSET_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material action asset residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material action asset residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material action asset residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material list item residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material preview asset residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG sidebar icon asset residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks 135 SVG material category helper asset pairs without category classes', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_HELPER_ASSET_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_HELPER_ASSET_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_CATEGORY_HELPER_ASSET_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material category helper asset residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material category helper asset residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material category helper asset residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material preview asset residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material action asset residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG sidebar icon asset residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks 135 SVG material list loader state without item-card controls', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_LOADER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_LOADER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_LIST_LOADER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material list loader residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material list loader residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material list loader residue')
  ...
  it('blocks 135 SVG material purchase child controls without item-card wrappers', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PURCHASE_CHILD_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PURCHASE_CHILD_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PURCHASE_CHILD_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('135 SVG material purchase control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('135 SVG material purchase control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('135 SVG material purchase control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material list item residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG material list loader residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })
  ...
  it('blocks 135 SVG material child controls without the parent editor panel wrapper', () => {
    const wechat = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PANEL_CHILD_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PANEL_CHILD_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_135_SVG_MATERIAL_PANEL_CHILD_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi placeholder metadata after text authoring cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PLACEHOLDER_METADATA_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PLACEHOLDER_METADATA_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PLACEHOLDER_METADATA_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi page and layer slots after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PAGE_LAYER_SLOT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PAGE_LAYER_SLOT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PAGE_LAYER_SLOT_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi sortable pin wrappers after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_SORTABLE_PIN_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_SORTABLE_PIN_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_SORTABLE_PIN_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi sortable pin residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi sortable pin residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi sortable pin residue')
  ...
  it('blocks Xiumi quick input wrappers after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi state toggles after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_STATE_TOGGLE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_STATE_TOGGLE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_STATE_TOGGLE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi state toggle residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi state toggle residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi state toggle residue')
  ...
  it('blocks Xiumi editing state wrappers after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_EDITING_STATE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_EDITING_STATE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_EDITING_STATE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi editing state residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi editing state residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi editing state residue')
  ...
  it('blocks Xiumi in-cell active states after gallery cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_IN_CELL_ACTIVE_STATE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_IN_CELL_ACTIVE_STATE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_IN_CELL_ACTIVE_STATE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi in-cell active state residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi in-cell active state residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi in-cell active state residue')
  ...
  it('blocks decomposed Xiumi component binding attributes from publishable outputs', () => {
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi atom context binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi atom context binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi atom context binding metadata residue')
  ...
  it('blocks Xiumi component template binding attributes separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_TEMPLATE_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_TEMPLATE_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_TEMPLATE_BINDING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component template binding residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component template binding residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component template binding residue')
  ...
  it('blocks Xiumi component identity metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_IDENTITY_METADATA_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_IDENTITY_METADATA_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_IDENTITY_METADATA_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component identity metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component identity metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component identity metadata residue')
  ...
  it('blocks Xiumi animation binding metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_BINDING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi animation binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi animation binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi animation binding metadata residue')
  ...
  it('blocks Xiumi link binding metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_LINK_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_LINK_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_LINK_BINDING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi link binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi link binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi link binding metadata residue')
  ...
  it('blocks Xiumi image binding metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_BINDING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi image binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi image binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi image binding metadata residue')
  ...
  it('blocks Xiumi component structure binding metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_STRUCTURE_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_STRUCTURE_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_STRUCTURE_BINDING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component structure binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component structure binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component structure binding metadata residue')
  ...
  it('blocks Xiumi cell binding metadata separately from broad component binding', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_CELL_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_CELL_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_CELL_BINDING_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi atom context binding metadata after broad component binding cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ATOM_CONTEXT_BINDING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ATOM_CONTEXT_BINDING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ATOM_CONTEXT_BINDING_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi atom drag-drop classes after atom-context cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ATOM_DRAG_DROP_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ATOM_DRAG_DROP_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ATOM_DRAG_DROP_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi auxiliary binding metadata after atom-context cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_AUXILIARY_BINDING_METADATA_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_AUXILIARY_BINDING_METADATA_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_AUXILIARY_BINDING_METADATA_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi auxiliary binding metadata residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi auxiliary binding metadata residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi auxiliary binding metadata residue')
  ...
  it('blocks Xiumi template card hover classes after visible-card cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_CARD_HOVER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_CARD_HOVER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_CARD_HOVER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi template card hover residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi template card hover residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi template card hover residue')
  ...
  it('blocks Xiumi layer authoring tree classes without layer-slot markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_LAYER_AUTHORING_TREE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_LAYER_AUTHORING_TREE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_LAYER_AUTHORING_TREE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi layer authoring tree residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi layer authoring tree residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi layer authoring tree residue')
  ...
  it('blocks Xiumi page authoring tree classes without page-slot or vessel markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PAGE_AUTHORING_TREE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PAGE_AUTHORING_TREE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PAGE_AUTHORING_TREE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi page authoring tree residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi page authoring tree residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi page authoring tree residue')
  ...
  it('blocks Xiumi template authoring tree classes without renderer pipeline attributes', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_AUTHORING_TREE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_AUTHORING_TREE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_AUTHORING_TREE_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi template list refresh directives with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_LIST_REFRESH_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_LIST_REFRESH_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_LIST_REFRESH_DIRECTIVE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi template list refresh directive residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi template list refresh directive residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi template list refresh directive residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi template entry block residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi source-house authoring residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi source-house authoring classes without broader tree markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_SOURCE_HOUSE_AUTHORING_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_SOURCE_HOUSE_AUTHORING_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_SOURCE_HOUSE_AUTHORING_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi source-house authoring residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi source-house authoring residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi source-house authoring residue')
  ...
  it('blocks Xiumi template scene markers after template tree cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_SCENE_MARKER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_SCENE_MARKER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEMPLATE_SCENE_MARKER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi template scene marker residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi template scene marker residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi template scene marker residue')
  ...
  it('blocks Xiumi image enhancement and crop child controls without worker parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_ENHANCEMENT_CROP_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_ENHANCEMENT_CROP_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_IMAGE_ENHANCEMENT_CROP_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi image enhancement crop control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi image enhancement crop control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi image enhancement crop control residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi WeChat cover control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi meta panel control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
  ...
  it('blocks Xiumi basic style fragment classes without template tree markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_BASIC_STYLE_FRAGMENT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_BASIC_STYLE_FRAGMENT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_BASIC_STYLE_FRAGMENT_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi basic style fragment residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi basic style fragment residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi basic style fragment residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi source-house authoring residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi theme color mask residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks Xiumi quick input instance classes after quick-input cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_INSTANCE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_INSTANCE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_QUICK_INPUT_INSTANCE_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi theme color mask classes after source-house cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_THEME_COLOR_MASK_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_THEME_COLOR_MASK_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_THEME_COLOR_MASK_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi theme color mask residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi theme color mask residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi theme color mask residue')
  ...
  it('blocks Xiumi document selection shell classes after root cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_DOCUMENT_SELECTION_SHELL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_DOCUMENT_SELECTION_SHELL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_DOCUMENT_SELECTION_SHELL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi document selection shell residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi document selection shell residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi document selection shell residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi paper document root residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi group ground marker residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
  ...
  it('blocks Xiumi Angular input source and mouse event attributes after class cleanup', () => {
  ...
  it('blocks Xiumi operation panel directives with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_DIRECTIVE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi operation panel directive residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi operation panel directive residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi operation panel directive residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operation panel loader residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operator dock control residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi component operation depot actions with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_OPERATION_DEPOT_ACTION_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_OPERATION_DEPOT_ACTION_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_OPERATION_DEPOT_ACTION_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component operation depot action residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component operation depot action residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component operation depot action residue')
  ...
  it('blocks Xiumi operation panel component controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_COMPONENT_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_COMPONENT_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_OPERATION_PANEL_COMPONENT_CONTROL_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi state loading utility controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_STATE_LOADING_UTILITY_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_STATE_LOADING_UTILITY_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_STATE_LOADING_UTILITY_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi state loading utility residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi state loading utility residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi state loading utility residue')
  ...
  it('blocks Xiumi component depot native controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_NATIVE_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_NATIVE_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_NATIVE_CONTROL_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi component depot SVG animation controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_SVG_ANIMATION_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_SVG_ANIMATION_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_SVG_ANIMATION_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot SVG animation residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot SVG animation residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot SVG animation residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi component depot native control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operator depot item residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi component depot external edit and link controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_EXTERNAL_EDIT_LINK_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_EXTERNAL_EDIT_LINK_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_EXTERNAL_EDIT_LINK_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot external edit link residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot external edit link residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot external edit link residue')
  ...
  it('blocks Xiumi component depot layout geometry controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_LAYOUT_GEOMETRY_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_LAYOUT_GEOMETRY_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_LAYOUT_GEOMETRY_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot layout geometry residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot layout geometry residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot layout geometry residue')
  ...
  it('blocks Xiumi component depot table controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot table control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot table control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot table control residue')
  ...
  it('blocks Xiumi component depot table auxiliary controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_AUXILIARY_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_AUXILIARY_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TABLE_AUXILIARY_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot table auxiliary residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot table auxiliary residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot table auxiliary residue')
  ...
  it('blocks Xiumi component depot image transform controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_IMAGE_TRANSFORM_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_IMAGE_TRANSFORM_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_IMAGE_TRANSFORM_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot image transform residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot image transform residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot image transform residue')
  ...
  it('blocks Xiumi component depot box style controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_BOX_STYLE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_BOX_STYLE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_BOX_STYLE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot box style residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot box style residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot box style residue')
  ...
  it('blocks Xiumi component depot typography controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TYPOGRAPHY_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TYPOGRAPHY_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_TYPOGRAPHY_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot typography control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot typography control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot typography control residue')
  ...
  it('blocks Xiumi component depot mobile viewport controls with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_MOBILE_VIEWPORT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_MOBILE_VIEWPORT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMPONENT_DEPOT_MOBILE_VIEWPORT_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi component depot mobile viewport residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi component depot mobile viewport residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi component depot mobile viewport residue')
  ...
  it('blocks Xiumi attribute board controls after depot cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_BOARD_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_BOARD_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_BOARD_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi attribute board control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi attribute board control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi attribute board control residue')
  ...
  it('blocks Xiumi generated link controls after attribute-board cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_GENERATED_LINK_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_GENERATED_LINK_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_GENERATED_LINK_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi generated link control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi generated link control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi generated link control residue')
  ...
  it('blocks Xiumi hidden media upload inputs without generated link controls', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_MEDIA_UPLOAD_INPUT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_MEDIA_UPLOAD_INPUT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_MEDIA_UPLOAD_INPUT_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi media upload input residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi media upload input residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi media upload input residue')
  ...
  it('blocks Xiumi audio library controls without panel or upload markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_LIBRARY_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_LIBRARY_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_LIBRARY_CONTROL_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi login layer shells without account or audio markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_LOGIN_LAYER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_LOGIN_LAYER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_LOGIN_LAYER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi login layer residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi login layer residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi login layer residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi audio panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi audio room tab residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi audio library control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi generated link control residue')
  ...
  it('blocks Xiumi audio panel controls without hidden upload inputs', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_AUDIO_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi audio panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi audio panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi audio panel residue')
  ...
  it('blocks Xiumi attribute stack panel controls without attribute-board markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_STACK_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_STACK_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ATTRIBUTE_STACK_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi attribute stack panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi attribute stack panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi attribute stack panel residue')
  ...
  it('blocks Xiumi layout form panels after operation-bar cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi layout form panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi layout form panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi layout form panel residue')
  ...
  it('blocks Xiumi layout form child controls without layout form parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_CHILD_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_CHILD_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_LAYOUT_FORM_CHILD_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi layout form child residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi layout form child residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi layout form child residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi layout form panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operation bar dropdown residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi generated link control residue')
  ...
  it('blocks Xiumi dark mask controls after cover cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_DARK_MASK_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_DARK_MASK_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_DARK_MASK_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi dark mask control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi dark mask control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi dark mask control residue')
  ...
  it('blocks Xiumi WeChat cover controls after generated-link cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_WECHAT_COVER_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_WECHAT_COVER_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_WECHAT_COVER_CONTROL_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi cover placeholder shells after cover menu cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COVER_PLACEHOLDER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COVER_PLACEHOLDER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COVER_PLACEHOLDER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi cover placeholder residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi cover placeholder residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi cover placeholder residue')
  ...
  it('blocks Xiumi cover image and description children after placeholder cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COVER_IMAGE_DESC_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COVER_IMAGE_DESC_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COVER_IMAGE_DESC_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi scale panel controls after WeChat-cover cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_SCALE_PANEL_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_SCALE_PANEL_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_SCALE_PANEL_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi scale panel control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi scale panel control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi scale panel control residue')
  ...
  it('blocks Xiumi menu input and icon controls after scale-panel cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_MENU_INPUT_ICON_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_MENU_INPUT_ICON_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_MENU_INPUT_ICON_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi menu input/icon control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi menu input/icon control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi menu input/icon control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi scale panel control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operation bar dropdown residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('135 SVG editor toolbar residue')
  ...
  it('blocks Xiumi hammer pan directive after overlay class cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_HAMMER_PAN_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_HAMMER_PAN_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_HAMMER_PAN_DIRECTIVE_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi crop panel child controls after worker-surface cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_CROP_PANEL_CHILD_CONTROLS_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_CROP_PANEL_CHILD_CONTROLS_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_CROP_PANEL_CHILD_CONTROLS_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi crop panel child control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi crop panel child control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi crop panel child control residue')
  ...
  it('blocks Xiumi background attribute controls after crop-panel cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_ATTRIBUTE_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_ATTRIBUTE_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_ATTRIBUTE_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi background attribute control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi background attribute control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi background attribute control residue')
  ...
  it('blocks Xiumi background bar child controls without background attribute parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_BAR_CHILD_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_BAR_CHILD_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_BACKGROUND_BAR_CHILD_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi animation attribute panel controls after background cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_ATTRIBUTE_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_ATTRIBUTE_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_ATTRIBUTE_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi animation attribute panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi animation attribute panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi animation attribute panel residue')
  ...
  it('blocks Xiumi animation panel child controls without parent board markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_PANEL_CHILD_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_PANEL_CHILD_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_PANEL_CHILD_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi animation panel child residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi animation panel child residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi animation panel child residue')
  ...
  it('blocks Xiumi animation style picker controls without animation list markers', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi animation style picker icon residue without style picker parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_ICON_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_ICON_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ANIMATION_STYLE_PICKER_ICON_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi UI Bootstrap modal directives after dropdown cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_UI_BOOTSTRAP_MODAL_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_UI_BOOTSTRAP_MODAL_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_UI_BOOTSTRAP_MODAL_DIRECTIVE_RESIDUE_HTML, 'zhihu')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message ?? '')
      .not.toContain('Xiumi dropdown directive residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message ?? '')
      .not.toContain('Angular/Vue authoring attribute')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks Xiumi modal runtime directives after UIB cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_MODAL_RUNTIME_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_MODAL_RUNTIME_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_MODAL_RUNTIME_DIRECTIVE_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi dropdown directives after Bootstrap directive cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_DROPDOWN_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_DROPDOWN_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_DROPDOWN_DIRECTIVE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi dropdown directive residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi dropdown directive residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi dropdown directive residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi UI Bootstrap control directive residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi tn-* attribute')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi color palette panels without color selector controls', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PALETTE_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PALETTE_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PALETTE_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi color palette panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi color palette panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi color palette panel residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operation bar dropdown residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi panel header control residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks Xiumi color picker triggers without palette panels', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PICKER_TRIGGER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PICKER_TRIGGER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COLOR_PICKER_TRIGGER_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi color selector controls after operation bar cleanup', () => {
  ...
  it('blocks Xiumi font and format controls after color selector cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_FONT_FORMAT_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_FONT_FORMAT_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_FONT_FORMAT_CONTROL_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi text input begin directives under font and format controls', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEXT_INPUT_BEGIN_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEXT_INPUT_BEGIN_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEXT_INPUT_BEGIN_DIRECTIVE_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi text operation sections after toolbar cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEXT_OPERATION_SECTION_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEXT_OPERATION_SECTION_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEXT_OPERATION_SECTION_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi text editing flyout controls without text toolbar parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_TEXT_EDITING_FLYOUT_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_TEXT_EDITING_FLYOUT_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_TEXT_EDITING_FLYOUT_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi text editing flyout residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi text editing flyout residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi text editing flyout residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi text toolbar control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi font and format control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operation bar dropdown residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi worker surface crop control residue')
  ...
  it('blocks Xiumi brush panel controls without text format parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_BRUSH_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_BRUSH_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_BRUSH_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi brush panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi brush panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi brush panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi text editing flyout residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi text toolbar control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi font and format control residue')
  ...
  it('blocks Xiumi attribute context menu host controls without depot parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ATTR_CONTEXT_HOST_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ATTR_CONTEXT_HOST_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ATTR_CONTEXT_HOST_RESIDUE_HTML, 'zhihu')
  ...
  it('blocks Xiumi menu pin controls without loader parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_MENU_PIN_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_MENU_PIN_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_MENU_PIN_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi menu pin control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi menu pin control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi menu pin control residue')
    ...
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi operator depot item residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi attribute context menu host residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks Xiumi account sync panel controls without user-info parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_ACCOUNT_SYNC_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_ACCOUNT_SYNC_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_ACCOUNT_SYNC_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi account sync panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi account sync panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi account sync panel residue')
  ...
  it('blocks Xiumi message panel controls without account panel parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_MESSAGE_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_MESSAGE_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_MESSAGE_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi message panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi message panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi message panel residue')
  ...
  it('blocks Xiumi user profile menu without account sync or message parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_USER_PROFILE_MENU_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_USER_PROFILE_MENU_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_USER_PROFILE_MENU_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi user profile menu residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi user profile menu residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi user profile menu residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi account sync panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi message panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi top operation button residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi editor prompt banners without working-pallet parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PROMPT_BANNER_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PROMPT_BANNER_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PROMPT_BANNER_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi editor prompt banner residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi editor prompt banner residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi editor prompt banner residue')
  ...
  it('blocks Xiumi header shell without navigation children', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_HEADER_SHELL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_HEADER_SHELL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_HEADER_SHELL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi header shell residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi header shell residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi header shell residue')
  ...
  it('blocks Xiumi editor interaction directives with a precise label', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_EDITOR_INTERACTION_DIRECTIVE_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_EDITOR_INTERACTION_DIRECTIVE_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_EDITOR_INTERACTION_DIRECTIVE_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi editor interaction directive residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi editor interaction directive residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi editor interaction directive residue')
  ...
  it('blocks Xiumi statistics panel controls without toolbar parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_STATISTICS_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_STATISTICS_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_STATISTICS_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi statistics panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi statistics panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi statistics panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi right toolbar control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi page toolbar residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi account sync panel residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
  ...
  it('blocks Xiumi comment toolbar classes after right-toolbar cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_COMMENT_TOOLBAR_PANEL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_COMMENT_TOOLBAR_PANEL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_COMMENT_TOOLBAR_PANEL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi comment toolbar panel residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi comment toolbar panel residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi comment toolbar panel residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi right toolbar control residue')
    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .not.toContain('Xiumi paper auxiliary component tree residue')
    expect(wechat.passed).toBe(false)
    expect(xhs.passed).toBe(false)
    expect(zhihu.passed).toBe(false)
  })

  it('blocks Xiumi panel header controls without panel parents', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PANEL_HEADER_CONTROL_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PANEL_HEADER_CONTROL_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PANEL_HEADER_CONTROL_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi panel header control residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi panel header control residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi panel header control residue')
  ...
  it('blocks Xiumi page toolbar classes after comment-toolbar cleanup', () => {
    const wechat = detectQuality(MARKET_EDITOR_XIUMI_PAGE_TOOLBAR_RESIDUE_HTML, 'wechat')
    const xhs = detectQuality(MARKET_EDITOR_XIUMI_PAGE_TOOLBAR_RESIDUE_HTML, 'xiaohongshu')
    const zhihu = detectQuality(MARKET_EDITOR_XIUMI_PAGE_TOOLBAR_RESIDUE_HTML, 'zhihu')

    expect(wechat.issues.find(issue => issue.id === 'wechat-market-editor-residue')?.message)
      .toContain('Xiumi page toolbar residue')
    expect(xhs.issues.find(issue => issue.id === 'xhs-market-editor-residue')?.message)
      .toContain('Xiumi page toolbar residue')
    expect(zhihu.issues.find(issue => issue.id === 'zhihu-market-editor-residue')?.message)
      .toContain('Xiumi page toolbar residue')
