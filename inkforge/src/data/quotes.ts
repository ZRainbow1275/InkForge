...
export const quotes: Quote[] = [
  ...
  { text: '世界上没有一条道路是重复的，也没有一个人生是可以替代的。', author: '莫言' },
  { text: '文学和科学相比，的确没什么用处，但文学最大的用处，也许就是它没有用处。', author: '莫言' },
  { text: '当众人都哭时，应该允许有的人不哭，当哭成为一种表演时，更应该允许有的人不哭。', author: '莫言' },
  { text: '世事犹如书中字，善读者可得其深意。', author: '莫言' },
  { text: '人在的时候，以为来日方长什么都有机会，其实人生是减法。', author: '莫言' },
